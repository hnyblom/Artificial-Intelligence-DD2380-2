...
//        std::cout << output_message.substr(4,4) << std::endl;
//        std::cout << output_message.substr(8,4) << std::endl;
//        std::cout << output_message.substr(12,4) << std::endl;
//        std::cout << output_message.substr(16,output_message.size()-16) << std::endl;
